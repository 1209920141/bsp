...
public class User implements BaseEntity<String> {
    @NotNull(message = "The userid shouldn't be null",groups = {InsertGroup.class, UpdateGroup.class, SelectGroup.class, DeleteGroup.class})  //addUser  user_id shouldn't be null updateuser selectsuer deleteuser
    String user_id;
